...
import kotlinx.android.synthetic.main.fragment_vehicles_click22.view.*


class VehiclesClick22 : Fragment() {

    private var mPlayer: MediaPlayer? = null
    private val nav = R.id.action_vehiclesClick22_to_vehiclesClick23
    ...
    override fun onCreateView(
        ...
        view.imageViewVehiclesKamyon.setOnClickListener {
            mPlayer?.stop()
            mPlayer?.release()
            animation(view.imageViewVehiclesKamyon)
