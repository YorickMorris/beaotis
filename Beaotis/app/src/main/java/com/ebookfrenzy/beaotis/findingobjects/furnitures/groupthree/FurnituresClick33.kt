...
import kotlinx.android.synthetic.main.fragment_furnitures_click33.*
...
class FurnituresClick33 : Fragment() {
    ...
    private val nav = R.id.action_furnituresClick33_to_furnituresClick34
    ...
    override fun onCreateView(
        ...
        view.imageViewFurnituresYatak1.setOnClickListener{
            mPlayer?.stop()
            mPlayer?.release()
            animation(view.imageViewFurnituresYatak1)
        }
        view.imageViewFurnituresSandalye1.setOnClickListener {
            mPlayer?.stop()
            mPlayer?.release()
            animationWrong(view.imageViewFurnituresSandalye1)
        }
        return view
    }
