...
import kotlinx.android.synthetic.main.fragment_fruits_click24.*
...
class FruitsClick24 : Fragment() {
    ...
    private val nav = R.id.action_fruitsClick24_to_fruitsSplash23
    ...
    override fun onCreateView(
        ...
        view.imageViewFruitsCilek2.setOnClickListener {
            mPlayer?.stop()
            mPlayer?.release()
            animation(view.imageViewFruitsCilek2)
        }
        view.imageViewFruitsMuz2.setOnClickListener {
            mPlayer?.stop()
            mPlayer?.release()
            animationWrong(view.imageViewFruitsMuz2)
        }
