...
class VegetablesClick24 : Fragment() {
    ...
    private val nav = R.id.action_vegetablesClick24_to_vegetablesSplash23
    ...
    override fun onCreateView(
        ...
        view.imageViewVegetablesPatates2.setOnClickListener {
            mPlayer?.stop()
            mPlayer?.release()
            animation(view.imageViewVegetablesPatates2)
        }
        view.imageViewVegetablesBiber2.setOnClickListener {
            mPlayer?.stop()
            mPlayer?.release()
            animationWrong(view.imageViewVegetablesBiber2)
        }
