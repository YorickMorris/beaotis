...
class FruitsClick27 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_fruits_click27, container, false)

        view.imageViewFruitsCilek4.setOnClickListener {
            findNavController().navigate(R.id.action_fruitsClick27_to_fruitsClick28)
        }
