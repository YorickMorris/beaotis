...
import kotlinx.android.synthetic.main.fragment_fruits_click214.view.*
import java.text.SimpleDateFormat
import java.util.*


class FruitsClick214 : Fragment() {
    private var mPlayer: MediaPlayer? = null
    private val nav = R.id.action_fruitsClick214_to_fruitsClick215
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_fruits_click214, container, false)

        view.imageViewFruitsNar.setOnClickListener {
            mPlayer?.stop()
            mPlayer?.release()
            animation(view.imageViewFruitsNar)
