...
import kotlinx.android.synthetic.main.fragment_furnitures_click13.*
...
class FurnituresClick13 : Fragment() {
    ...
    private val nav = R.id.action_furnituresClick13_to_furnituresClick14
    private val item = R.raw.bicak
    ...
    override fun onCreateView(
        ...
        view.imageViewFurnituresBicak1.setOnClickListener{
            mPlayer?.stop()
            mPlayer?.release()
            animation(view.imageViewFurnituresBicak1)
        }
        view.imageViewFurnituresCatal1.setOnClickListener {
            mPlayer?.stop()
            mPlayer?.release()
            animationWrong(view.imageViewFurnituresCatal1)
        }
