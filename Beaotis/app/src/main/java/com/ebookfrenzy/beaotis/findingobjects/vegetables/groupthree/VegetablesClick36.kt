...
class VegetablesClick36 : Fragment() {
    ...
    private val nav = R.id.action_vegetablesClick36_to_vegetablesClick37
    ...
    override fun onCreateView(
        ...
        view.imageViewVegetablesPatlican3.setOnClickListener {
            mPlayer?.stop()
            mPlayer?.release()
            animation(view.imageViewVegetablesPatlican3)
        }
        view.imageViewVegetablesSalatalik3.setOnClickListener {
            mPlayer?.stop()
            mPlayer?.release()
            animationWrong(view.imageViewVegetablesSalatalik3)
        }
        view.imageViewVegetablesSogan1.setOnClickListener {
            mPlayer?.stop()
            mPlayer?.release()
            animationWrong(view.imageViewVegetablesSogan1)
        }
