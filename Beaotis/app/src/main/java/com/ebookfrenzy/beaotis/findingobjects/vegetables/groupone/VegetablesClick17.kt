...
class VegetablesClick17 : Fragment() {
    ...
    private val nav = R.id.action_vegetablesClick17_to_vegetablesClick18
    ...
    override fun onCreateView(
        ...
        view.imageViewVegetablesHavuc4.setOnClickListener {
            mPlayer?.stop()
            mPlayer?.release()
            animation(view.imageViewVegetablesHavuc4)
        }
        view.imageViewVegetablesDomates4.setOnClickListener {
            mPlayer?.stop()
            mPlayer?.release()
            animationWrong(view.imageViewVegetablesDomates4)
        }
        view.imageViewVegetablesLimon2.setOnClickListener {
            mPlayer?.stop()
            mPlayer?.release()
            animationWrong(view.imageViewVegetablesLimon2)
        }
