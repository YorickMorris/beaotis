...
import kotlinx.android.synthetic.main.fragment_fruits_click39.view.*
import java.text.SimpleDateFormat
import java.util.*


class FruitsClick39 : Fragment() {
    private var mPlayer: MediaPlayer? = null
    private val nav = R.id.action_fruitsClick39_to_fruitsClick310
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_fruits_click39, container, false)

        view.imageViewFruitsKavun.setOnClickListener {
            if(mPlayer!=null&& mPlayer!!.isPlaying){
                mPlayer?.stop()
                mPlayer?.release()
                mPlayer=null
            }
            animation(view.imageViewFruitsKavun)
