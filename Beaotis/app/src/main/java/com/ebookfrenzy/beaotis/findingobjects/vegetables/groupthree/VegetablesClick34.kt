...
class VegetablesClick34 : Fragment() {
    ...
    private val nav = R.id.action_vegetablesClick34_to_vegetablesSplash33
    ...
    override fun onCreateView(
        ...
        view.imageViewVegetablesSalatalik2.setOnClickListener {
            mPlayer?.stop()
            mPlayer?.release()
            animation(view.imageViewVegetablesSalatalik2)
        }
        view.imageViewVegetablesPatlican2.setOnClickListener {
            mPlayer?.stop()
            mPlayer?.release()
            animationWrong(view.imageViewVegetablesPatlican2)
        }
        return view
    }
