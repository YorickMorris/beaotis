...
import kotlinx.android.synthetic.main.fragment_fruits_click29.view.*
import java.text.SimpleDateFormat
import java.util.*


class FruitsClick29 : Fragment() {
    private var mPlayer: MediaPlayer? = null
    private val nav = R.id.action_fruitsClick29_to_fruitsClick210
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_fruits_click29, container, false)

        view.imageViewFruitsMandalina.setOnClickListener {
            if(mPlayer!=null&& mPlayer!!.isPlaying){
                mPlayer?.stop()
                mPlayer?.release()
                mPlayer=null
            }
            animation(view.imageViewFruitsMandalina)
