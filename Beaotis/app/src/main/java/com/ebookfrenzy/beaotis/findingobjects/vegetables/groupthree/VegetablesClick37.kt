...
class VegetablesClick37 : Fragment() {
    ...
    private val nav = R.id.action_vegetablesClick37_to_vegetablesClick38
    ...
    override fun onCreateView(
        ...
        view.imageViewVegetablesSalatalik4.setOnClickListener {
            mPlayer?.stop()
            mPlayer?.release()
            animation(view.imageViewVegetablesSalatalik4)
        }
        view.imageViewVegetablesPatlican4.setOnClickListener {
            mPlayer?.stop()
            mPlayer?.release()
            animationWrong(view.imageViewVegetablesPatlican4)
        }
        view.imageViewVegetablesSogan2.setOnClickListener {
            mPlayer?.stop()
            mPlayer?.release()
            animationWrong(view.imageViewVegetablesSogan2)
        }
