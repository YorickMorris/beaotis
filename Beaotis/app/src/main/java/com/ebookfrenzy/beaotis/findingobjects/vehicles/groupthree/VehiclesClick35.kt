...
import kotlinx.android.synthetic.main.fragment_vehicles_click35.view.*


class VehiclesClick35 : Fragment() {

    private var mPlayer: MediaPlayer? = null
    private val nav = R.id.action_vehiclesClick35_to_vehiclesClick36
    ...
    override fun onCreateView(
        ...
        view.imageViewVehiclesUcak.setOnClickListener {
            mPlayer?.stop()
            mPlayer?.release()
            animation(view.imageViewVehiclesUcak)
        }
        return view
    }
