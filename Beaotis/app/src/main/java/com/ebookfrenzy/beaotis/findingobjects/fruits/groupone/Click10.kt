...
class Click10 : Fragment() {
    ...
    private val nav = R.id.action_click10_to_click11
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_click10, container, false)

        view.imageViewFruitsElma6.setOnClickListener {
            if(mPlayer!=null&& mPlayer!!.isPlaying){
                mPlayer?.stop()
                mPlayer?.release()
                mPlayer=null
            }
            animation(view.imageViewFruitsElma6)
            finish=System.currentTimeMillis()
            fark=finish-start
            fark /= 1000
            firebaseBitirmeSuresiEntry()
        }
        view.imageViewFruitsArmut6.setOnClickListener {
            if(mPlayer!=null&& mPlayer!!.isPlaying){
                mPlayer?.stop()
                mPlayer?.release()
                mPlayer=null
            }
            animationWrong(view.imageViewFruitsArmut6)
            firebaseYanlisEntry()
        }
        view.imageViewFruitsAnanas5.setOnClickListener {
            ...
            animationWrong(view.imageViewFruitsAnanas5)
            firebaseYanlisEntry()
        }
        view.imageViewFruitsBogurtlen1.setOnClickListener {
            if(mPlayer!=null&& mPlayer!!.isPlaying){
                mPlayer?.stop()
                mPlayer?.release()
                mPlayer=null
            }
            animationWrong(view.imageViewFruitsBogurtlen1)
            firebaseYanlisEntry()
        }
